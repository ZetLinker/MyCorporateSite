...
const ITSupportSection: React.FC = () => {
  const sectionRef = useRef<HTMLDivElement>(null);
  const theme = useTheme();
  const isMobile = useMediaQuery(theme.breakpoints.down("sm"));

  // Service items data for IT Support
  const services = [
    {
      number: "01.",
      title: "相談窓口",
      description:
        "サービスに関する質問やトラブルが発生した際に対応する窓口です。迅速かつ親切な対応を行い、解決策を提供します。",
    },
    {
      number: "02.",
      title: "使用方法説明",
      description:
        "システムやサービスの利用方法について、わかりやすいマニュアル等を提供します。ユーザーが迷わず操作できるようサポートし、効率的な利用を促進します。",
    },
    {
      number: "03.",
      title: "サービスフィードバック",
      description:
        "サービスの運用状況を確認し、ユーザーからのフィードバックを基に機能の追加や調整を行います。",
    },
    {
      number: "04.",
      title: "システムメンテナンス",
      description:
        "システムの定期保守やセキュリティ対策を実施し、安定したパフォーマンスを保ちます。",
    },
    {
      number: "05.",
      title: "デザインメンテナンス",
      description:
        "お客様からのご要望に応じて、デザインの調整や改善を行い、常に最新で魅力的なデザインを保ちます。",
    },
    {
      number: "06.",
      title: "システム監視",
      description:
        "システムの稼働状況を監視し、異常が発生した際に迅速に対応します。",
    },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ウェブサイトの運用からシステムのメンテナンス、アップデートまで、安定した稼働をサポートします。最新技術の導入や、トラブル発生時の対応を通じて、安心して運用を続けられる体制を整えます。
            </Typography>
          </Box>
        </CustomRectangle>
        <CustomRectangle
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              はい、定期的なデザインレビューと調整を行い、最新のデザインを保つサポートを提供します。
            </Typography>
          </Box>
        </CustomRectangle>
        ...
        >
          ...
          >
            ...
            >
              ユーザーのフィードバックを集約し、運用状況の確認をもとにサービスの改善を提案します。
            </Typography>
          </Box>
        </CustomRectangle>
